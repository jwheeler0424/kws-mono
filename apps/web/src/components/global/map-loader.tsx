...
const BouncingLoader = () => {
  return (
    <div className={cn('relative flex h-32 w-32 flex-col items-center justify-center')}>
      <div className='top-1/4 size-20 animate-bounce'>
        <svg
          viewBox='0 0 500 820'
          height={80}
          width={80}
      ...
      <div className='animate-grow -mt-2 h-5 w-20 bg-[radial-gradient(closest-side,rgba(0,0,0,0.8),rgba(0,0,0,0.0))]'></div>
    </div>
  );
};
export const MapLoader = () => {
  return (
    <main className='absolute top-1/2 left-1/2 z-40 -translate-x-1/2 -translate-y-1/2'>
      <BouncingLoader />
    </main>
  );
};
