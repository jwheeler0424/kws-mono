...
export function iconLinks(opts: IconLinksOptions): SeoLinkTag[] {
  ...
  if (opts.icon32) links.push({ rel: 'icon', type: 'image/png', sizes: '32x32', href: opts.icon32 })
  if (opts.icon16) links.push({ rel: 'icon', type: 'image/png', sizes: '16x16', href: opts.icon16 })
  if (opts.icon96) links.push({ rel: 'icon', type: 'image/png', sizes: '96x96', href: opts.icon96 })
  if (opts.appleTouchIcon) links.push({ rel: 'apple-touch-icon', sizes: '180x180', href: opts.appleTouchIcon })
  if (opts.maskIcon) links.push({ rel: 'mask-icon', href: opts.maskIcon.href, color: opts.maskIcon.color })
  if (opts.manifest) {
    links.push({ rel: 'manifest', href: opts.manifest, ...(opts.themeColor ? { color: opts.themeColor } : {}) })
  }
